...
import com.nikede.feature_coin_api.domain.use_case.get_coin.GetCoinUseCase
...
/**
 * ViewModel of CoinDetailScreen
 */
@HiltViewModel
internal class CoinDetailViewModel @Inject constructor(
    ...
    /**
     * Getting a coin from UseCase by ID of the coin
     *
